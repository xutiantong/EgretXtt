...
var DRAGONBONES = (function () {
     ...
     * png：纹理集
     */
    DRAGONBONES.prototype.addToFactory = function (ske, json, png) {
     ...
     *
     */
    DRAGONBONES.prototype.playAnimation = function (armaturename, animationname, groupname, com, playtime, scaleX, scaleY, speed, maskboundname, layer) {
        this.dragonBones_arr.forEach(function (v, i) {
            if (armaturename == v.name) {
                var armature = v.gujia;
                armature.anchorOffsetX = 0;
     ...
     */
    DRAGONBONES.prototype.changeslotimg = function (bei_armaturename, bei_slotname, bei_slotdisplayname, forarmaturename_nicheng, forslotname) {
        var b;
        this.dragonBones_arr.forEach(function (v, i) {
